...
function Attendance() {
 ...
 function Screen() {
  const screens = { Dashboard, Bookings, Supervisor, "Supervisor A-Z Sync": SupervisorAZSync, "Operations Advanced": OperationsAdvanced, "Customer Portal": CustomerPortal, "Marketing Automation": MarketingAutomation, Calendar, CRM, "Customer History": CustomerHistory, Marketing, Services, Staff, Attendance, Payroll, Inventory, Expenses, Payments, Reminders, Invoices, Complaints, ProfitAnalysis, Reports, FirebaseSync, Settings };
